-- Fix auto_create_confirmation_tasks function to ensure due_at is never NULL
-- This prevents "null value in column 'due_at' violates not-null constraint" errors
