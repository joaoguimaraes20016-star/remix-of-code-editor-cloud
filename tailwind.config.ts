  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Builder-specific colors for flow-canvas
        builder: {
          bg: "hsl(var(--builder-bg))",
          surface: "hsl(var(--builder-surface))",
          "surface-hover": "hsl(var(--builder-surface-hover))",
          "surface-active": "hsl(var(--builder-surface-active))",
          border: "hsl(var(--builder-border))",
          "border-subtle": "hsl(var(--builder-border-subtle))",
          text: "hsl(var(--builder-text))",
          "text-secondary": "hsl(var(--builder-text-secondary))",
          "text-muted": "hsl(var(--builder-text-muted))",
          "text-dim": "hsl(var(--builder-text-dim))",
          accent: "hsl(var(--builder-accent))",
          "accent-glow": "hsl(var(--builder-accent-glow))",
          "accent-muted": "hsl(var(--builder-accent-muted))",
          "accent-secondary": "hsl(var(--builder-accent-secondary))",
        ...
        canvas: {
          ...
          "frame-border": "hsl(var(--canvas-frame-border))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      keyframes: {
        ...
        // Additional animations for funnel builder
        "fade-up": {
          "0%": {
            opacity: "0",
            transform: "translateY(20px)",
