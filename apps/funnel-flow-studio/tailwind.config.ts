  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Marquee animations for logo bar
        "marquee-left": {
      ...
      animation: {
        ...
        "marquee-medium": "marquee-left 30s linear infinite",
        "marquee-fast": "marquee-left 15s linear infinite",
        "marquee-slow-right": "marquee-right 60s linear infinite",
        "marquee-medium-right": "marquee-right 30s linear infinite",
        "marquee-fast-right": "marquee-right 15s linear infinite",
      },
