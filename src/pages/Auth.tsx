    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden items-center justify-center p-12 bg-slate-950">
        ...
        <img 
          src={authHeroBg}
          alt=""
          className="absolute inset-0 w-full h-full object-cover opacity-25 animate-float-bg"
        />
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <Card className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl w-[360px] shadow-2xl overflow-hidden relative">
            {/* Subtle glow effect */}
