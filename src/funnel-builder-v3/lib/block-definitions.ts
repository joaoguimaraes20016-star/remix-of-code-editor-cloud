...
export const blockDefinitions: Record<BlockType, BlockDefinition> = {
  ...
  testimonial: {
    ...
    defaultStyles: { ...defaultStyles, backgroundColor: 'hsl(var(--card))', borderRadius: 16, padding: { top: 24, right: 24, bottom: 24, left: 24 }, shadow: 'sm' },
  },
  reviews: {
    type: 'reviews',
    name: 'Reviews',
    ...
    defaultContent: {
      reviews: [
        { id: '1', text: 'Absolutely amazing!', author: 'John D.', rating: 5 },
        { id: '2', text: 'Best investment I\'ve made.', author: 'Emily R.', rating: 5 },
      ],
    },
    defaultStyles,
  },
