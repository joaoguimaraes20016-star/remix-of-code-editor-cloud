...
const NODE_CATEGORIES: NodeCategory[] = [
  {
    ...
    nodes: [
      ...
      { type: "send_whatsapp", label: "Send WhatsApp", description: "Send WhatsApp message", icon: <MessageCircle className="h-4 w-4" />, color: "text-primary" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { type: "add_tag", label: "Add Tag", description: "Tag for segmentation", icon: <Tag className="h-4 w-4" />, color: "text-primary" },
  ...
  },
  {
    ...
    nodes: [
      ...
      { type: "close_deal", label: "Close Deal", description: "Mark deal as won/lost", icon: <CheckCircle className="h-4 w-4" />, color: "text-primary" },
  ...
  },
  {
    ...
    label: "Payments",
    nodes: [
      { type: "send_invoice", label: "Send Invoice", description: "Create and send invoice", icon: <Receipt className="h-4 w-4" />, color: "text-primary" },
      { type: "charge_payment", label: "Charge Payment", description: "One-time charge", icon: <CreditCard className="h-4 w-4" />, color: "text-primary" },
