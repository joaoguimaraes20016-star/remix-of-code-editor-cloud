...
export function HorizontalAppointmentCard({
  ...
  return (
    <Card className={cn(
      ...
      {appointment.original_appointment_id && (
        <div className="mt-3 text-sm p-3 rounded-lg border-l-4 font-semibold bg-purple-500/10 border-purple-400 text-purple-700 dark:bg-purple-500/15 dark:text-purple-300">
