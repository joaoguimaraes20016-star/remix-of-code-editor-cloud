...
export const ACTION_META: Record<ActionType, ActionMeta> = {
  ...
  add_tag: { type: 'add_tag', label: 'Add Tag', description: 'Tag for segmentation', icon: 'Tag', color: 'text-green-400', bgColor: 'bg-green-500/20', category: 'crm' },
  ...
  add_task: { type: 'add_task', label: 'Create Task', description: 'Assign a follow-up task', icon: 'ClipboardList', color: 'text-purple-400', bgColor: 'bg-purple-500/20', category: 'crm' },
  add_note: { type: 'add_note', label: 'Add Note', description: 'Add a note to record', icon: 'StickyNote', color: 'text-amber-400', bgColor: 'bg-amber-500/20', category: 'crm' },
  ...
  close_deal: { type: 'close_deal', label: 'Close Deal', description: 'Mark deal as won/lost', icon: 'CheckCircle', color: 'text-rose-400', bgColor: 'bg-rose-500/20', category: 'pipeline' },
  time_delay: { type: 'time_delay', label: 'Wait', description: 'Pause before next step', icon: 'Clock', color: 'text-orange-400', bgColor: 'bg-orange-500/20', category: 'flow' },
  wait_until: { type: 'wait_until', label: 'Wait Until', description: 'Wait until date/time', icon: 'CalendarClock', color: 'text-orange-400', bgColor: 'bg-orange-500/20', category: 'flow' },
  ...
  condition: { type: 'condition', label: 'If / Else', description: 'Branch based on conditions', icon: 'GitBranch', color: 'text-amber-400', bgColor: 'bg-amber-500/20', category: 'flow' },
  split_test: { type: 'split_test', label: 'A/B Split', description: 'Random split testing', icon: 'Split', color: 'text-pink-400', bgColor: 'bg-pink-500/20', category: 'flow' },
  ...
  run_workflow: { type: 'run_workflow', label: 'Run Workflow', description: 'Trigger another automation', icon: 'PlayCircle', color: 'text-fuchsia-400', bgColor: 'bg-fuchsia-500/20', category: 'flow' },
  ...
  enqueue_dialer: { type: 'enqueue_dialer', label: 'Power Dialer', description: 'Add to dialer queue', icon: 'Phone', color: 'text-red-400', bgColor: 'bg-red-500/20', category: 'integration' },
};
