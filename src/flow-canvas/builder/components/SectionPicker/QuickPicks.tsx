...
const QuickPickCard = ({ label, description, icon, gradient, onClick }: QuickPickCardProps) => (
  <button
    ...
    className={cn(
      ...
      "hover:border-[hsl(var(--builder-accent)/0.5)] hover:shadow-lg",
  ...
  >
    ...
    {/* Label */}
    <span className="text-sm font-semibold text-[hsl(var(--builder-text))] mb-1">
      {label}
    </span>
    <span className="text-xs text-[hsl(var(--builder-text-muted))] text-center">
      {description}
    </span>
  </button>
);
