...
const blockTemplates: BlockTemplate[] = [
  // ============ LAYOUT SECTIONS ============
  {
    ...
    label: 'Navigation',
    icon: <Menu size={18} />,
    description: 'Framer-style header with logo & pill links',
    category: 'layout',
    template: () => ({
      id: generateId(),
      type: 'custom',
      label: 'Navigation',
      elements: [
        { id: generateId(), type: 'text', content: 'Brand®', props: { variant: 'logo', fontWeight: 'bold', fontSize: '18px' } },
      ...
      props: { layout: 'navbar', sticky: true, transparent: false, direction: 'row', alignItems: 'center', justifyContent: 'space-between', gap: '8px' },
      styles: { padding: '20px 48px' },
    }),
  },
  {
    type: 'hero',
